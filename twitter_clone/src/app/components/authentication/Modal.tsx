        ...
        <>
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-hidden fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800 bg-opacity-70">
                <div className="relative w-full lg:w-3/6 my-6 mx-auto lg:max-w-3xl h-full lg:h-auto">
                    { }
                    <div className="h-ful lg:h-auto border-0 rounded-lg shadow-lg relatie flex flex-col w-full bg-black outline-none focuse:outline-none">
                        {/* header */}
                        <div className="flex w-full  items-center justify-evenly p-10 rounded-t">
